...
import { product_Drop } from "../Data/home";
import useInViewAnimation from "../Hook/useInViewAnimation.js";
function Drop({ handleWishlist, currentWishlistActive }) {
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col mt-2">
                ...
                <h2 className="text-black max-w-[9rem] md:max-w-full overflow-hidden whitespace-nowrap text-ellipsis">
                  {item.product_name}
                </h2>
              </div>
