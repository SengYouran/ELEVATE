...
function Profile() {
  ...
  return (
    <div className={`md:w-[73%] ${showHidden ? "hidden md:blcok" : "blcok"}`}>
      ...
      <form onSubmit={handleUpdate} className="mt-4 flex flex-col gap-4">
        ...
        <div className="relative">
          ...
          />
          <i className="fa-solid fa-check border-black text-black border-l-2 border-r-1 border-b-2 p-[3px] rounded-[50%] absolute top-1/2 right-3"></i>
        </div>
        ...
        >
          ...
          />
          <i
            className="fa-solid fa-calendar-days text-xl text-black absolute top-1/2 right-3 cursor-pointer"
            onClick={() => refData.current?.showPicker?.()}
          ></i>
          <p className="text-xs text-green-600">
            Add your birthday to unlock additional offering/reward! 04/03/2001
          </p>
        </div>
