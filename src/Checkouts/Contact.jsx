...
function Contact() {
  ...
  const { userAccount, currentAccount, handleContact } = useDataContext();
  ...
  useEffect(() => {
    ...
    const filterContact = userIndex?.storeContact;
          ...
          >
            <label htmlFor={`contactDelivery-${render.id}`}>
              <input
                ...
                type="checkbox"
                className="accent-black w-[15px] h-[15px] cursor-pointer mt-0.5"
