  ...
  return (
    <div className="flex flex-col gap-6 mx-4 xl:mx-40 mt-[4rem] sm:mt-[7rem]">
      ...
      >
        <div>
          <h2>
            {formattedPath} ({totalItems} {totalItems > 1 ? "Items" : "Item"})
          </h2>
        </div>
        <div className="flex items-center gap-2 px-3 py-1 border border-black cursor-pointer">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 -mt-6 gap-6">
        {currentItems.map((item, index) => {
          ...
          const discountRate =
            parseFloat(item.discount?.replace("-", "").replace("%", "") || 0) /
            100;
